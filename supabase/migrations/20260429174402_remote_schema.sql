...
ALTER TYPE "public"."OKRCategory" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "authenticative"."is_user_authenticated"() RETURNS boolean
    ...
    SET "search_path" TO 'authenticative', 'public', 'pg_temp'
    AS $$
...
CREATE OR REPLACE FUNCTION "public"."bulk_approve_applications"("p_event_id" "uuid", "p_application_ids" "uuid"[], "p_approved_by" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql"
...
ALTER FUNCTION "public"."bulk_approve_applications"("p_event_id" "uuid", "p_application_ids" "uuid"[], "p_approved_by" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."call_welcome_email_function"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."call_welcome_email_function"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_my_chapter_id"() RETURNS "text"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "public"."is_event_editor"("event_uuid" "uuid") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."is_event_editor"("event_uuid" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."is_event_editor"("p_user_id" "uuid", "p_event_id" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
  SELECT EXISTS (
...
ALTER FUNCTION "public"."is_event_editor"("p_user_id" "uuid", "p_event_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."sync_user_role_to_claims"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
...
ALTER FUNCTION "public"."sync_user_role_to_claims"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."event_chapter" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."event_chapter" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."event_registration_with_event" AS
 SELECT "er"."id",
    "er"."event_id",
    "er"."user_id",
    "er"."registered_at",
...
ALTER VIEW "public"."event_registration_with_event" OWNER TO "postgres";


CREATE OR REPLACE VIEW "public"."event_with_chapter" AS
 SELECT "e"."id",
    "e"."title",
    "e"."description",
    "e"."cover_image",
...
ALTER VIEW "public"."event_with_chapter" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."recruiter_access" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."recruiter_access" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."resume_download_log" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."resume_download_log" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."saved_student" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "recruiter_id" "uuid" NOT NULL,
    "student_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."saved_student" OWNER TO "postgres";
...
CREATE OR REPLACE TRIGGER "welcome_email_trigger" AFTER INSERT ON "public"."user" FOR EACH ROW EXECUTE FUNCTION "public"."call_welcome_email_function"();
...
GRANT ALL ON FUNCTION "public"."bulk_approve_applications"("p_event_id" "uuid", "p_application_ids" "uuid"[], "p_approved_by" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."bulk_approve_applications"("p_event_id" "uuid", "p_application_ids" "uuid"[], "p_approved_by" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."bulk_approve_applications"("p_event_id" "uuid", "p_application_ids" "uuid"[], "p_approved_by" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."call_welcome_email_function"() TO "anon";
GRANT ALL ON FUNCTION "public"."call_welcome_email_function"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."call_welcome_email_function"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."is_event_editor"("event_uuid" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_event_editor"("event_uuid" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."is_event_editor"("p_user_id" "uuid", "p_event_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."is_event_editor"("p_user_id" "uuid", "p_event_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_event_editor"("p_user_id" "uuid", "p_event_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."sync_user_role_to_claims"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_user_role_to_claims"() TO "service_role";
...
GRANT ALL ON TABLE "public"."event_chapter" TO "anon";
GRANT ALL ON TABLE "public"."event_chapter" TO "authenticated";
GRANT ALL ON TABLE "public"."event_chapter" TO "service_role";



GRANT ALL ON TABLE "public"."event_registration" TO "anon";
GRANT ALL ON TABLE "public"."event_registration" TO "authenticated";
GRANT ALL ON TABLE "public"."event_registration" TO "service_role";



GRANT ALL ON TABLE "public"."event_registration_with_event" TO "anon";
GRANT ALL ON TABLE "public"."event_registration_with_event" TO "authenticated";
GRANT ALL ON TABLE "public"."event_registration_with_event" TO "service_role";



GRANT ALL ON TABLE "public"."event_with_chapter" TO "anon";
GRANT ALL ON TABLE "public"."event_with_chapter" TO "authenticated";
GRANT ALL ON TABLE "public"."event_with_chapter" TO "service_role";



GRANT ALL ON TABLE "public"."recruiter_access" TO "anon";
GRANT ALL ON TABLE "public"."recruiter_access" TO "authenticated";
GRANT ALL ON TABLE "public"."recruiter_access" TO "service_role";
...
GRANT ALL ON TABLE "public"."resume_download_log" TO "anon";
GRANT ALL ON TABLE "public"."resume_download_log" TO "authenticated";
GRANT ALL ON TABLE "public"."resume_download_log" TO "service_role";



GRANT ALL ON TABLE "public"."saved_student" TO "anon";
GRANT ALL ON TABLE "public"."saved_student" TO "authenticated";
GRANT ALL ON TABLE "public"."saved_student" TO "service_role";



GRANT ALL ON TABLE "public"."student_profile" TO "anon";
GRANT ALL ON TABLE "public"."student_profile" TO "authenticated";
...
CREATE TRIGGER on_auth_user_created AFTER INSERT ON auth.users FOR EACH ROW EXECUTE FUNCTION public.handle_new_user();
  ...
  create policy "Admins manage all event covers"
  on "storage"."objects"
  as permissive
  for all
  to public
using (((bucket_id = 'event-covers'::text) AND (auth.uid() IN ( SELECT "user".id
   FROM public."user"
...
using ((bucket_id = 'event-covers'::text));
  ...
  create policy "Editors delete own event covers"
  on "storage"."objects"
  as permissive
  for delete
  to public
using (((bucket_id = 'event-covers'::text) AND (auth.uid() = ((storage.foldername(name))[1])::uuid) AND (auth.uid() IN ( SELECT "user".id
   FROM public."user"
  WHERE ("user".role = 'editor'::public."Role")))));



  create policy "Editors update own event covers"
  on "storage"."objects"
  as permissive
  for update
  to public
using (((bucket_id = 'event-covers'::text) AND (auth.uid() = ((storage.foldername(name))[1])::uuid) AND (auth.uid() IN ( SELECT "user".id
  ...
  create policy "Editors upload event covers"
  on "storage"."objects"
  as permissive
  for insert
  to public
with check (((bucket_id = 'event-covers'::text) AND (auth.uid() IN ( SELECT "user".id
   FROM public."user"
  WHERE ("user".role = 'editor'::public."Role")))));



  create policy "Give anon users access to JPG images in folder 1uswaj_0"
  on "storage"."objects"
  as permissive
  for select
  to public
using (((bucket_id = 'video'::text) AND (storage.extension(name) = 'jpg'::text) AND (lower((storage.foldername(name))[1]) = 'public'::text) AND (auth.role() = 'anon'::text)));



  create policy "Students upload own resume (alt)"
  on "storage"."objects"
  as permissive
  for insert
  to public
with check (((bucket_id = 'resumes'::text) AND (name ~~ ((auth.uid())::text || '/%'::text))));

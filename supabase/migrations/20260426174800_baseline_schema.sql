...
\restrict 2C6UIqWAloUDrml0HIAA0Y0cedwJlgMJjN126oKFfh75xkIyX32ONWR5nz954Ak
...
--
-- Name: authenticative; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA authenticative;
...
--
-- Name: is_user_authenticated(); Type: FUNCTION; Schema: authenticative; Owner: -
--

CREATE FUNCTION authenticative.is_user_authenticated() RETURNS boolean
...
--
-- Name: resume_storage_backup_20260416_2001; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.resume_storage_backup_20260416_2001 (
    id uuid,
    bucket_id text,
    name text,
    owner uuid,
...
--
-- Name: studentprofile_backup_20260416_2001; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.studentprofile_backup_20260416_2001 (
    "userId" uuid,
    major text,
    ...
    "approvalStatus" public.approval_status,
    "memberId" text,
    gender text
);
...
--
-- Name: user_backup_20260416_2001; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.user_backup_20260416_2001 (
    id uuid,
    email text,
    name text,
    role public."Role",
...
--
-- Name: student_profile student_profile_insert_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY student_profile_insert_own ON public.student_profile FOR INSERT WITH CHECK ((user_id = auth.uid()));
...
--
-- Name: user user_insert_authenticated; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY user_insert_authenticated ON public."user" FOR INSERT TO authenticated WITH CHECK (true);
...
--
-- Name: objects Admins manage all event covers; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Admins manage all event covers" ON storage.objects USING (((bucket_id = 'event-covers'::text) AND (auth.uid() IN ( SELECT "user".id
   FROM public."user"
  WHERE ("user".role = 'admin'::public."Role")))));


--
-- Name: objects Allow authenticated read resumes; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow authenticated read resumes" ON storage.objects FOR SELECT TO authenticated USING ((bucket_id = 'resumes'::text));


--
-- Name: objects Allow authenticated uploads to resumes; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow authenticated uploads to resumes" ON storage.objects FOR INSERT TO authenticated WITH CHECK ((bucket_id = 'resumes'::text));


--
-- Name: objects Allow update resumes; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow update resumes" ON storage.objects FOR UPDATE TO authenticated USING ((bucket_id = 'resumes'::text)) WITH CHECK ((bucket_id = 'resumes'::text));


--
-- Name: objects Editors delete own event covers; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Editors delete own event covers" ON storage.objects FOR DELETE USING (((bucket_id = 'event-covers'::text) AND (auth.uid() = ((storage.foldername(name))[1])::uuid) AND (auth.uid() IN ( SELECT "user".id
   FROM public."user"
  WHERE ("user".role = 'editor'::public."Role")))));


--
-- Name: objects Editors update own event covers; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Editors update own event covers" ON storage.objects FOR UPDATE USING (((bucket_id = 'event-covers'::text) AND (auth.uid() = ((storage.foldername(name))[1])::uuid) AND (auth.uid() IN ( SELECT "user".id
   FROM public."user"
  WHERE ("user".role = 'editor'::public."Role")))));


--
-- Name: objects Editors upload event covers; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Editors upload event covers" ON storage.objects FOR INSERT WITH CHECK (((bucket_id = 'event-covers'::text) AND (auth.uid() IN ( SELECT "user".id
   FROM public."user"
  WHERE ("user".role = 'editor'::public."Role")))));


--
-- Name: objects Give anon users access to JPG images in folder 1uswaj_0; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Give anon users access to JPG images in folder 1uswaj_0" ON storage.objects FOR SELECT USING (((bucket_id = 'video'::text) AND (storage.extension(name) = 'jpg'::text) AND (lower((storage.foldername(name))[1]) = 'public'::text) AND (auth.role() = 'anon'::text)));


--
-- Name: objects Public read event covers; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Public read event covers" ON storage.objects FOR SELECT USING ((bucket_id = 'event-covers'::text));


--
-- Name: objects Students upload own resume (alt); Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Students upload own resume (alt)" ON storage.objects FOR INSERT WITH CHECK (((bucket_id = 'resumes'::text) AND (name ~~ ((auth.uid())::text || '/%'::text))));


--
-- Name: objects Users can read resumes; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Users can read resumes" ON storage.objects FOR SELECT TO authenticated USING ((bucket_id = 'resumes'::text));


--
-- Name: objects Users can update resumes; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Users can update resumes" ON storage.objects FOR UPDATE TO authenticated USING ((bucket_id = 'resumes'::text));


--
-- Name: objects Users can upload resumes; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Users can upload resumes" ON storage.objects FOR INSERT TO authenticated WITH CHECK ((bucket_id = 'resumes'::text));
...
\unrestrict 2C6UIqWAloUDrml0HIAA0Y0cedwJlgMJjN126oKFfh75xkIyX32ONWR5nz954Ak

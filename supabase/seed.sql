...
INSERT INTO public.person_profile (
  ...
  ('11111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'Universidad Nacional de Ingenieria', 'Datos y politicas publicas', 2028, 'https://linkedin.com/in/test-participant', 'https://test-participant.dev', ARRAY['Investigacion', 'Eventos'], 'prefer_not_to_say', false),
  ('22222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 'Universidad Nacional de Ingenieria', 'Ingenieria industrial', 2027, 'https://linkedin.com/in/test-member', 'https://test-member.dev', ARRAY['Operaciones', 'Analitica'], 'woman', true),
  ('33333333-3333-3333-3333-333333333333', '33333333-3333-3333-3333-333333333333', 'Universidad Nacional de Ingenieria', 'Ingenieria de software', 2026, 'https://linkedin.com/in/test-editor', 'https://test-editor.dev', ARRAY['Liderazgo', 'React', 'SQL'], 'man', false),
  ('44444444-4444-4444-4444-444444444444', '44444444-4444-4444-4444-444444444444', 'LEAD Peru', 'Administracion de plataforma', null, 'https://linkedin.com/in/test-admin', null, ARRAY['Gobernanza', 'Operaciones'], 'prefer_not_to_say', false),
  ('55555555-5555-5555-5555-555555555555', '55555555-5555-5555-5555-555555555555', 'LEAD Peru', 'Operaciones de programa', null, 'https://linkedin.com/in/test-staff', null, ARRAY['Programas', 'Comunidad'], 'prefer_not_to_say', false),
  ('66666666-6666-6666-6666-666666666666', '66666666-6666-6666-6666-666666666666', 'Test Company', 'Reclutamiento', null, 'https://linkedin.com/in/test-recruiter', null, ARRAY['Contratacion', 'Talento'], 'prefer_not_to_say', false),
  ...
  ('81000000-0000-4000-8000-000000000001', '81000000-0000-4000-8000-000000000001', 'Universidad Nacional de Ingenieria', 'Ingenieria industrial', 2026, 'https://linkedin.com/in/test-president', 'https://test-president.dev', ARRAY['Liderazgo', 'Estrategia'], 'woman', true),
  ('81000000-0000-4000-8000-000000000002', '81000000-0000-4000-8000-000000000002', 'Universidad Nacional de Ingenieria', 'Ciencias de la computacion', 2026, 'https://linkedin.com/in/test-vp', 'https://test-vp.dev', ARRAY['Operaciones', 'Eventos'], 'man', true),
  ('81000000-0000-4000-8000-000000000003', '81000000-0000-4000-8000-000000000003', 'Universidad Nacional de Ingenieria', 'Marketing', 2027, 'https://linkedin.com/in/test-eboard', 'https://test-eboard.dev', ARRAY['Marketing', 'Comunidad'], 'prefer_not_to_say', true);
...
INSERT INTO public.event (
  ...
  ('92000000-0000-4000-8000-000000000004', 'Panel de IA e innovacion', 'Panel sobre inteligencia artificial e innovacion. Exploramos el impacto de la IA en distintas industrias y oportunidades para estudiantes.', null, '2025-07-22 21:00:00+00', '2025-07-23 00:00:00+00', 'Universidad Nacional de Ingenieria (UNI)', null, 'in_person', null, true, 'leaduni', '33333333-3333-3333-3333-333333333333', 'open', null, 'Universidad Nacional de Ingenieria (UNI)', null, 'Lima', 'Lima', -12.0247, -77.0483, null),
  ...
  ('92000000-0000-4000-8000-000000000008', 'Sprint de diseno de producto', 'Taller intensivo de diseno de productos. Aprende metodologias de design thinking, investigacion y prototipado rapido.', null, '2025-10-10 19:00:00+00', '2025-10-10 23:00:00+00', 'Universidad Privada del Norte (UPN)', null, 'in_person', null, true, 'leadupn', '44444444-4444-4444-4444-444444444444', 'open', null, 'Universidad Privada del Norte (UPN)', null, 'Lima', 'Lima', -11.9618, -77.0679, null),
  ...
  ('92000000-0000-4000-8000-000000000022', 'Clinica de empleabilidad', 'Clinica de empleabilidad con revision de CV, simulacion de entrevistas y consejos para procesos de seleccion.', null, '2026-08-15 20:00:00+00', '2026-08-15 23:00:00+00', 'Online', 'https://meet.google.com/lead-career-readiness', 'online', 150, true, 'leaduni', '33333333-3333-3333-3333-333333333333', 'open', null, 'Online', null, null, null, null, null, null),
  ...
  ('92000000-0000-4000-8000-000000000026', 'Laboratorio de comunicacion publica', 'Laboratorio para practicar presentaciones, recibir feedback y ganar confianza al comunicar ideas.', null, '2026-10-03 15:00:00+00', '2026-10-03 18:00:00+00', 'Universidad Nacional de San Agustin de Arequipa', null, 'in_person', 50, true, 'leadunsa', '44444444-4444-4444-4444-444444444444', 'open', null, 'Universidad Nacional de San Agustin de Arequipa', null, 'Arequipa', 'Arequipa', -16.3988, -71.5369, null),
  ('92000000-0000-4000-8000-000000000027', 'Reto de impacto comunitario', 'Reto colaborativo para disenar iniciativas de impacto comunitario y presentar una propuesta accionable.', null, '2026-10-17 14:00:00+00', '2026-10-17 22:00:00+00', 'Universidad Cientifica del Sur', null, 'in_person', 40, true, 'leaducsur', '44444444-4444-4444-4444-444444444444', 'application', null, 'Universidad Cientifica del Sur', null, 'Lima', 'Lima', -12.1619, -76.9764, null),
  ('92000000-0000-4000-8000-000000000028', 'Taller de investigacion UX', 'Workshop aplicado para aprender entrevistas, sintesis de hallazgos y priorizacion de oportunidades de producto.', null, '2026-10-29 21:00:00+00', '2026-10-30 00:00:00+00', 'Universidad de Ingenieria y Tecnologia (UTEC)', null, 'hybrid', 65, true, 'leadutec', '44444444-4444-4444-4444-444444444444', 'open', null, 'Universidad de Ingenieria y Tecnologia (UTEC)', null, 'Lima', 'Lima', -12.1348, -77.0224, null),
...
INSERT INTO public.funding_request (
  ...
  (
    ...
    'Fortalecer habilidades de liderazgo, comunicación y colaboración en nuevos miembros de LEAD UNI.',
    ...
    NULL,
    NULL,
    'Solicitud piloto para probar el flujo de revisión.',
    '2026-06-12',
    false,
    NOW() - INTERVAL '2 days',
    NULL,
  ...
  (
    ...
    '92000000-0000-4000-8000-000000000022',
    'Refrigerios para Clinica de empleabilidad',
    'Apoyar una clínica de empleabilidad con mentores y revisión de CV para estudiantes.',
    'Estudiantes que están preparando prácticas y primeros procesos profesionales',
    90,
    420.00,
    350.00,
    NULL,
    ...
    NULL,
    NULL,
    'Admin aprobó monto parcial priorizando comida y materiales impresos.',
    '2026-08-15',
    false,
    NOW() - INTERVAL '8 days',
    '44444444-4444-4444-4444-444444444444',
  ...
  (
    ...
    '92000000-0000-4000-8000-000000000015',
    'Regularización de IBM Integration Day',
    'Registrar comprobantes pendientes de un evento de integración y aprendizaje para miembros.',
    ...
    'IBM',
    'Apoyo de contenido y mentoría; sin transferencia directa del partner.',
    ...
    'El evento ya se realizó; queda pendiente regularizar comprobantes.',
  ...
  (
    ...
    '81000000-0000-4000-8000-000000000001',
    NULL,
    'Kit de activación interna LEAD UNI',
    'Preparar materiales base para entrenamiento de e-board y mejora de operaciones del capítulo.',
    ...
    NULL,
    NULL,
    'Iniciativa interna, no evento público.',
    '2026-06-30',
    false,
    NULL,
    NULL,
...
INSERT INTO public.funding_request_budget_item (
  ...
  ('f2000000-0000-4000-8000-000000000001', 'f1000000-0000-4000-8000-000000000001', 'Materiales impresos', 'event_materials', 120.00, 'Hojas de trabajo y dinámicas.', 1),
  ('f2000000-0000-4000-8000-000000000002', 'f1000000-0000-4000-8000-000000000001', 'Refrigerios modestos', 'food_refreshments', 180.00, 'Agua y snacks para participantes.', 2),
  ...
  ('f2000000-0000-4000-8000-000000000005', 'f1000000-0000-4000-8000-000000000002', 'Materiales de revisión de CV', 'learning_materials', 90.00, NULL, 2),
  ('f2000000-0000-4000-8000-000000000006', 'f1000000-0000-4000-8000-000000000002', 'Decoración mínima de registro', 'minimal_decorations', 70.00, 'No incluida en el monto parcial aprobado.', 3),
  ('f2000000-0000-4000-8000-000000000007', 'f1000000-0000-4000-8000-000000000003', 'Coffee break de integración', 'food_refreshments', 210.00, NULL, 1),
  ('f2000000-0000-4000-8000-000000000008', 'f1000000-0000-4000-8000-000000000003', 'Certificados de participación', 'recognition_items', 70.00, 'Reconocimiento ligado a aprendizaje.', 2),
...
INSERT INTO public.funding_request_file (
  ...
  (
    ...
    'Cotización externa de ejemplo para QA.'
  ),
  (
...
INSERT INTO public.funding_request_status_event (
  ...
  ('f4000000-0000-4000-8000-000000000001', 'f1000000-0000-4000-8000-000000000001', '81000000-0000-4000-8000-000000000001', 'draft', 'submitted', 'Solicitud enviada para revisión.', '{}'::jsonb, NOW() - INTERVAL '2 days'),
  ('f4000000-0000-4000-8000-000000000002', 'f1000000-0000-4000-8000-000000000002', '81000000-0000-4000-8000-000000000002', 'draft', 'submitted', 'Solicitud enviada para revisión.', '{}'::jsonb, NOW() - INTERVAL '8 days'),
  ...
  ('f4000000-0000-4000-8000-000000000004', 'f1000000-0000-4000-8000-000000000003', '81000000-0000-4000-8000-000000000003', 'draft', 'submitted', 'Solicitud enviada para revisión.', '{}'::jsonb, NOW() - INTERVAL '32 days'),
  ...
  ('f4000000-0000-4000-8000-000000000006', 'f1000000-0000-4000-8000-000000000003', '44444444-4444-4444-4444-444444444444', 'approved', 'receipts_due', 'Comprobantes pendientes de regularización.', '{}'::jsonb, NOW() - INTERVAL '1 day'),

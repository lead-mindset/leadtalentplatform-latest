  ...
  return (
    <div className="container max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-8">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-4xl font-bold tracking-tight">About LEAD</h1>
      ...
      {/* Programs Section */}
      <div className="space-y-6">
        <h2 className="text-3xl font-bold tracking-tight text-center">What We Offer</h2>
      ...
      <Card className="bg-primary/5 border-primary/20">
        <CardContent className="py-8 text-center">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            ...
            already building their future with LEAD.
          </p>

...
const COPY = {
  es: {
    ...
    noItems: 'Aún no hay empresas creadas',
    ...
    createDescription: 'El nombre de la empresa debe ser único.',
    ...
    deleteConfirmDescription: 'se eliminará solo si no tiene representantes activos ni invitaciones pendientes.',
  },
  en: {
    sortColumns: {
      name: 'Company',

...
const COPY = {
  es: {
    ...
    filtersDescription: 'Busca capitulos y ordena por columnas operativas.',
    searchAria: 'Buscar capitulos por nombre o universidad',
    ...
    edit: 'Editar',
    delete: 'Eliminar',
    deleteBlockedTitle: 'No se puede eliminar mientras el capitulo tenga miembros o eventos activos.',
    deleteTitle: 'Eliminar capitulo',
    deleteBlocked: 'Bloqueado por miembros o eventos activos.',
    noMatches: 'No hay capitulos con esos filtros',
    noItems: 'Aun no hay capitulos creados',
    clearHelp: 'Limpia los filtros o prueba otra busqueda.',
    createHelp: 'Crea el primer capitulo para empezar.',
    ...
    createTitle: 'Crear capitulo',
    createDescription: 'Completa los datos del capitulo y asigna editores si corresponde.',
    chapterId: 'ID del capitulo (slug)',
    name: 'Nombre',
    university: 'Universidad',
    city: 'Ciudad',
    region: 'Region',
    cancel: 'Cancelar',
    create: 'Crear',
    editTitle: 'Editar capitulo',
    save: 'Guardar',
    editorsTitle: 'Asignar liderazgo de capitulo',
    editorsDescription: 'Selecciona miembros aprobados para dar responsabilidad y permisos operativos del capitulo.',
    noAvailableEditors: 'No hay miembros aprobados disponibles para asignar en este capitulo.',
    saving: 'Guardando...',
    saveAssignments: 'Guardar asignaciones',
    createdToast: 'Capitulo creado.',
    updatedToast: 'Capitulo actualizado.',
    deletedToast: 'Capitulo eliminado.',
    assignmentsToast: 'Asignaciones actualizadas.',
    deleteConfirmTitle: 'Eliminar capitulo?',
    deleteConfirmDescription: 'se eliminara permanentemente si no tiene miembros ni eventos.',
  },
  en: {
    sortColumns: {
      name: 'Chapter',

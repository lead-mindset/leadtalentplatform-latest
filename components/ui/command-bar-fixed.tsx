          ...
          <AnimatePresence mode="wait">
            {isSearchOpen ? (
              ...
              >
                ...
                />
                <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-[#6b7a9c]" />
              </motion.div>
            ) : (
              <motion.button
                initial={{ opacity: 0 }}
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="relative">
            ...
            >
              ...
              <ChevronDown className={`w-3 h-3 text-[#6b7a9c] transition-transform ${isProfileOpen ? "rotate-180" : ""}`} />
            </motion.button>

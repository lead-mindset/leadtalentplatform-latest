...
export default function ChapterEboardInviteEmail({
  ...
  const t = {
    es: {
      ...
      cta: 'Crea tu cuenta o inicia sesion usando exactamente el correo invitado. Al completar el onboarding, tu membresia y acceso al dashboard del chapter se activaran automaticamente.',
      button: 'Activar mi acceso',
      roleLabel: 'Rol',
      chapterLabel: 'Chapter',
      emailLabel: 'Correo que debes usar',
      note: 'Si el correo, chapter o rol no se ve correcto, escribe antes de crear una segunda cuenta.',
    ...
    en: {
      ...
      cta: 'Create your account or sign in using the exact invited email. After onboarding, your chapter membership and dashboard access will activate automatically.',
      button: 'Activate my access',
      roleLabel: 'Role',
      chapterLabel: 'Chapter',
      emailLabel: 'Email to use',
      note: 'If the email, chapter, or role looks wrong, write before creating a second account.',
      help: 'Need help?',
    },
  }[locale]
